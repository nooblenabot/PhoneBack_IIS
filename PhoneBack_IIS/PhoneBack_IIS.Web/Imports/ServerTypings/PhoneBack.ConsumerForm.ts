namespace PhoneBack_IIS.PhoneBack {
    ...
    [['IsMorale', () => Serenity.BooleanEditor], ['IsActive', () => Serenity.BooleanEditor], ['IsArchive', () => Serenity.BooleanEditor], ['InsertDate', () => Serenity.DateEditor], ['InsertUserId', () => Serenity.IntegerEditor], ['UpdateDate', () => Serenity.DateEditor], ['UpdateUserId', () => Serenity.IntegerEditor], ['CorporateName', () => Serenity.StringEditor], ['ConsumerName', () => Serenity.StringEditor], ['ConsumerStatus', () => Serenity.LookupEditor], ['AlertStatusConsumer', () => Serenity.StringEditor], ['Adress1', () => Serenity.StringEditor], ['Adress2', () => Serenity.StringEditor], ['City', () => Serenity.LookupEditor], ['Country', () => Serenity.LookupEditor], ['Cedex', () => Serenity.StringEditor], ['Phone', () => Serenity.StringEditor], ['Gsm', () => Serenity.StringEditor], ['Email1', () => Serenity.StringEditor], ['Caption', () => Serenity.StringEditor], ['InactiveDate', () => Serenity.DateEditor], ['ArchiveDate', () => Serenity.DateEditor]].forEach(x => Object.defineProperty(ConsumerForm.prototype, <string>x[0], { get: function () { return this.w(x[0], (x[1] as any)()); }, enumerable: true, configurable: true }));
}
